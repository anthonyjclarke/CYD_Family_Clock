...
const TimezoneInfo timezones[] = {
  ...
  {"Phoenix, USA", "MST7"},
  {"Calgary, Canada", "MST7MDT,M3.2.0,M11.1.0"},
  {"Edmonton, Canada", "MST7MDT,M3.2.0,M11.1.0"},
  {"Halifax, Canada", "AST4ADT,M3.2.0,M11.1.0"},
  {"Montreal, Canada", "EST5EDT,M3.2.0,M11.1.0"},
  {"Ottawa, Canada", "EST5EDT,M3.2.0,M11.1.0"},
  {"Regina, Canada", "CST6"},
  {"St. John's, Canada", "NST3:30NDT,M3.2.0,M11.1.0"},
  {"Toronto, Canada", "EST5EDT,M3.2.0,M11.1.0"},
  {"Vancouver, Canada", "PST8PDT,M3.2.0,M11.1.0"},
  {"Winnipeg, Canada", "CST6CDT,M3.2.0,M11.1.0"},
  ...
  // ==================== AFRICA (89-101) ====================
  {"Accra, Ghana", "GMT0"},
  {"Addis Ababa, Ethiopia", "EAT-3"},
  {"Algiers, Algeria", "CET-1"},
  {"Cairo, Egypt", "EET-2"},
  {"Casablanca, Morocco", "WET0WEST,M3.5.0,M10.5.0/3"},
  {"Dar es Salaam, Tanzania", "EAT-3"},
  {"Johannesburg, South Africa", "SAST-2"},
  {"Khartoum, Sudan", "CAT-2"},
  {"Kinshasa, DR Congo", "WAT-1"},
  {"Lagos, Nigeria", "WAT-1"},
  {"Nairobi, Kenya", "EAT-3"},
  {"Tunis, Tunisia", "CET-1"},
  {"Windhoek, Namibia", "CAT-2"}
};
